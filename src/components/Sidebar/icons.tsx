...
export const CardapiosIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const EstoqueIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const RefeicoesIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const SolicitacoesExtrasIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const RelatoriosIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const UsuariosIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const TerminalIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const PerfisPermissoesIcon = ({ color = "currentColor", width = 26.25, height = 26.25, className }: SidebarIconProps) => (
...
export const LogsAuditoriaIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const ConfiguracoesIcon = ({ color = "currentColor", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const SairIcon = ({ color = "currentColor", width = 24, height = 24, className }: SidebarIconProps) => (
