...
export const DashboardIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
...
export const CardapiosIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const EstoqueIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const RefeicoesIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const SolicitacoesExtrasIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const RelatoriosIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const UsuariosIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const TerminalIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const PerfisPermissoesIcon = ({ color = "#4A5565", width = 26.25, height = 26.25, className }: SidebarIconProps) => (
...
export const LogsAuditoriaIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const ConfiguracoesIcon = ({ color = "#4A5565", width = 28, height = 28, className }: SidebarIconProps) => (
  <svg width={width} height={height} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} style={{ display: "block", flexShrink: 0 }}>
...
export const SairIcon = ({ color = "#4A5565", width = 24, height = 24, className }: SidebarIconProps) => (
