...
const ArrowIcon = ({ color = "#FFFFFF", width = 24, height = 24, className }: SVGIconProps) => (
  <svg width={width} height={height} className={className} style={{ display: "block", flexShrink: 0 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    <path d="M4.99902 11.998H18.9969" stroke={color} stroke-width="1.9997" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M11.998 5L18.997 11.9989L11.998 18.9979" stroke={color} stroke-width="1.9997" stroke-linecap="round" stroke-linejoin="round" />
  </svg>
);

const FileIcon = ({ color = "#FFFFFF", width = 24, height = 24, className }: SVGIconProps) => (
  <svg width={width} height={height} className={className} style={{ display: "block", flexShrink: 0 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M4 22V2H16V4H14V8H18V6H20V22H4ZM12 4H6V20H18V10H12V4Z" fill={color} />
...
const CSVIcon = ({ color = "#FFFFFF", width = 24, height = 24, className }: SVGIconProps) => (
  <svg width={width} height={height} className={className} style={{ display: "block", flexShrink: 0 }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
    ...
    <path fill-rule="evenodd" clip-rule="evenodd" d="M13 16V14H11V12H9V14H11V16H9V18H11V16H13ZM13 16V18H15V16H13Z" fill={color} />
  </svg>
);
